...
const data = [
    {
        id: 1,
        image: Image1,
        title: "Responsive design using CSS",
        description:
    ...
    },
    {
        id: 2,
        image: Image2,
        title: "Web Development using React js , Laravel",
        description:
    ...
    },
    {
        id: 3,
        image: Image3,
        title: "Database Management using MySQL",
        description:
            "Ensuring that a Data is stored and retrieved efficiently",
    },
];
